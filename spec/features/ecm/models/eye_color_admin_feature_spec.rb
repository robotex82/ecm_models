...
feature 'Ecm::Models::EyeColor admin' do
  ...
  def set_resource_path
    @resource_path = "model-augenfarben"
  end

  def set_resource_class
    @resource_class = Ecm::Models::EyeColor
  end
  ...
  def fill_new_form
    fill_in "ecm_models_eye_color[name_de]", :with => "Blau"
    fill_in "ecm_models_eye_color[name_en]", :with => "blue"
    fill_in "ecm_models_eye_color[name_es]", :with => "azul"
  end

  def fill_edit_form
    fill_in "ecm_models_eye_color[name_de]", :with => "Grün"
    fill_in "ecm_models_eye_color[name_en]", :with => "green"
    fill_in "ecm_models_eye_color[name_es]", :with => "verde"
  end
