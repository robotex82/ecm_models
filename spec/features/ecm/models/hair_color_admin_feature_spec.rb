...
feature 'Ecm::Models::HairColor admin' do
  ...
  def set_resource_path
    @resource_path = "model-haarfarben"
  end

  def set_resource_class
    @resource_class = Ecm::Models::HairColor
  end
  ...
  def fill_new_form
    fill_in "ecm_models_hair_color[name_de]", :with => "Blond"
    fill_in "ecm_models_hair_color[name_en]", :with => "blonde"
    fill_in "ecm_models_hair_color[name_es]", :with => "rubio"
  end

  def fill_edit_form
    fill_in "ecm_models_hair_color[name_de]", :with => "Schwarz"
    fill_in "ecm_models_hair_color[name_en]", :with => "black"
    fill_in "ecm_models_hair_color[name_es]", :with => "negro"
  end
