...
feature 'Ecm::Models::Gender admin' do
  ...
  def set_resource_path
    @resource_path = "geschlechter"
  end

  def set_resource_class
    @resource_class = Ecm::Models::Gender
  end
  ...
  def fill_new_form
    fill_in "ecm_models_gender[name_de]", :with => "Männer"
    fill_in "ecm_models_gender[name_en]", :with => "men"
    fill_in "ecm_models_gender[name_es]", :with => "hombres"
  end

  def fill_edit_form
    fill_in "ecm_models_gender[name_de]", :with => "Frauen"
    fill_in "ecm_models_gender[name_en]", :with => "women"
    fill_in "ecm_models_gender[name_es]", :with => "mujeres"
  end
