...
feature 'Ecm::Models::SkinType admin' do
  ...
  def set_resource_path
    @resource_path = "model-hauttypen"
  end

  def set_resource_class
    @resource_class = Ecm::Models::SkinType
  end
  ...
  def fill_new_form
    fill_in "ecm_models_skin_type[name_de]", :with => "europäisch"
    fill_in "ecm_models_skin_type[name_en]", :with => "european"
    fill_in "ecm_models_skin_type[name_es]", :with => "europeo"
  end

  def fill_edit_form
    fill_in "ecm_models_skin_type[name_de]", :with => "siatisch"
    fill_in "ecm_models_skin_type[name_en]", :with => "asian"
    fill_in "ecm_models_skin_type[name_es]", :with => "asiatico"
  end
