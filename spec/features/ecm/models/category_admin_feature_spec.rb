...
feature 'Ecm::Models::Category admin' do
  ...
  def set_resource_path
    @resource_path = "model-kategorien"
  end

  def set_resource_class
    @resource_class = Ecm::Models::Category
  end
  ...
  def fill_new_form
    fill_in "ecm_models_category[name_de]", :with => "Profi"
    fill_in "ecm_models_category[name_en]", :with => "professional"
    fill_in "ecm_models_category[name_es]", :with => "profesional"
  end

  def fill_edit_form
    fill_in "ecm_models_category[name_de]", :with => "Amateur"
    fill_in "ecm_models_category[name_en]", :with => "amateur"
    fill_in "ecm_models_category[name_es]", :with => "aficionado"
  end
